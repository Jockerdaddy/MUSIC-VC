...
[![Deploy on Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Jockerdaddy/Music-VC)
...
```bash
$ git clone https://github.com/Jockerdaddy/Music-VC
$ cd MusicPlayer
$ cp sample.env .env
